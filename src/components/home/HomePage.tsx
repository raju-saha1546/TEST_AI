      ...
      >
        ...
        <div className="relative z-10 max-w-3xl space-y-7">
          ...
          <div className="space-y-3 text-base sm:text-lg text-slate-300 leading-relaxed font-sans max-w-2xl">
            <p>
              I am an undergraduate physics student dedicated to understanding physical systems
              from first principles. I focus on unpacking the mathematical reasoning behind fundamental
              equations, verifying theoretical models through experimental bench measurements, and implementing
              computational simulations and discrete scientific instrumentation.
            </p>
          </div>
